...
namespace OOP.Lab1.Tests
{
	...
	public class VectorTests
	{
		...
		public void TestConstructor()
		{
			Vector v1 = new Vector(.9, -.9);
            Assert.AreEqual(.9, v1.DX);
            Assert.AreEqual(-.9, v1.DY);
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => new Vector(-1.001, 1.001));
        }
		[TestMethod]
		public void TestSet()
		{
            ...
            v1.Set(-0.9, 0.9);
			Assert.AreEqual(-0.9, v1.DX);
			Assert.AreEqual(0.9, v1.DY);
		}
	}
	[TestClass]
